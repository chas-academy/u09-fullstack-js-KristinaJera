...
const ContactUs = () => {
  ...
  // Assume this function retrieves the role from your authentication context or storage
  const getUserRole = () => {
    return localStorage.getItem('userRole') || 'user'; // Default to 'user' if not found
  };
