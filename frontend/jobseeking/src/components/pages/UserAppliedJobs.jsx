        ...
        {loading ? (
          ...
          <div className="flex flex-wrap -my-8 container mx-auto">
            {applications.map(app => (
              <div key={app._id} className="py-8 px-4 lg:w-1/3 transition-transform transform hover:scale-105 duration-300">
                <div className="h-full flex flex-col justify-between bg-gradient-to-r from-blue-100 to-purple-100 shadow-lg hover:shadow-xl rounded-lg p-6 transition-shadow duration-300">
                  <div className="flex-grow">
                    ...
                    <p className="leading-relaxed mb-1 font-medium">Status: {app.status}</p>
                    ...
                    <p className="leading-relaxed mb-1">
                      Resume: <a href={app.resume} target="_blank" rel="noopener noreferrer" className="text-indigo-500 hover:underline">View Resume</a>
                    </p>
                    <p className="leading-relaxed mb-1">Cover Letter: {app.coverLetter || 'N/A'}</p>
                    ...
                    <Link to={`/job/${app.job?._id}`} className="text-indigo-600 inline-flex items-center mt-3 hover:underline transition duration-200">
                      View Job
